 ...
 * Debe guardar la hora en la memoria EEPROM cuando suceda algún inconveniente después 
 * que la casa sea asegurada. Para ello, debe ingresar un contrasena de 5 digitos 
 * (guardados en la EEPROM)que dará 25 segundos para salir de la casa y que los sensores 
 * se activen. Si la alarma se enciende, obligatoriamente debe digitar la contraseña para 
 * apagarla. Además, debe tener una función de poder cambiarla en caso de necesitarlo. 
 * El ingreso de la misma puede ser por teclado matricial o comunicación serial. Toda 
 * la información del estado de la alarma se lo debe visualizar en una lcd.
 */
